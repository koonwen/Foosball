...
public class GameBoard extends View {
    ...
    // Bitmaps
    private final Bitmap bmTeamA = BitmapFactory.decodeResource(getResources(), R.drawable.ship1);
    private final Bitmap bmTeamB = BitmapFactory.decodeResource(getResources(), R.drawable.ship2);
    private final Bitmap bmBall = BitmapFactory.decodeResource(getResources(), R.drawable.ball);
